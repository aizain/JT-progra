			...
			<tbody>
				...
				<tr class="hide addGroupTr">
					...
					<td>
                        <ul>
                            <li>
                                <a href="javascript:void(0)" class="easyui-linkbutton addGroup">
                                                            添加分组
                                </a>
                            </li>
                        </ul>
        ...
        <li class="param">
            <ul>
                <li>
                    ...
                    <a href="javascript:void(0)" class="easyui-linkbutton addParam icon-add"></a>
                </li>
                <li>
                    <span>|----------</span>
                    <input style="width:150px;" class="easyui-textbox" name="param"/>&nbsp;
                    <a href="javascript:void(0)" class="easyui-linkbutton delParam icon-cancel"></a>
                </li>
            </ul>
        </li>
	</div>
...
<script type="text/javascript">
	$(function() {
			...
			fun : function(node) {
			    ...
			    $.getJSON("/item/param/query/itemcatid/" + node.id, function(data) {
			       if(200 == data.status && data.data) {
			           //$.messaget.alert("提示", "该类自己已经添加其他类目", undefined, function(){
			           //});
			           alert("该类自己已经添加其他类目");
		...
		$(".addGroup").click(function() {
		    var temple = $(".itemParamAddTemplate li").eq(0).clone();	//复制html片段
		    $(this).parent().parent().append(temple); //插入表格该模版
